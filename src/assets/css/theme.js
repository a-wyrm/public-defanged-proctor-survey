...
export const theme = {
  ...
  panel: {
    ...
    description:
      "small sv_p_description small form-text text-muted small form-text text-muted small form-text text-muted",
  ...
  paneldynamic: {
    ...
    progressText: "sv-paneldynamic__progress-text sv-hidden",
