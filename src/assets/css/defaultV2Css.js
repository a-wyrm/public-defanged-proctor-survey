export var surveyCss = {
  ...
  getAvailableThemes: function () {
    return Object.keys(this).filter(
      (propertyName) =>
        ["currentType", "getCss", "getAvailableThemes"].indexOf(
          propertyName
        ) === -1
    );
  },
...
export var defaultV2Css = {
  ...
  panel: {
    ...
    errorsContainer:
      "sd-panel__errbox sd-element__erbox sd-element__erbox--above-element",
  },
  paneldynamic: {
    mainRoot:
      "sd-element  sd-question sd-question--paneldynamic sd-element--complex sd-question--complex sd-row__question",
    ...
    noEntriesPlaceholder:
      "sd-paneldynamic__placeholder sd-question__placeholder",
    compact: "sd-element--with-frame sd-element--compact",
  ...
  question: {
    ...
    headerTop:
      "sd-question__header--location-top sd-element__header--location-top",
    headerBottom: "sd-question__header--location--bottom",
    content: "sd-question__content",
    contentSupportContainerQueries:
    ...
    descriptionUnderInput:
      "sd-description sd-question__description sd-question__description--under-input",
    ...
    errorsContainerTop:
      "sd-element__erbox--above-element sd-question__erbox--above-question",
  ...
  boolean: {
    ...
    rootRadio:
      "sv_qcbc sv_qbln sd-scrollable-container sd-scrollable-container--compact",
    item: "sd-boolean",
  ...
  matrix: {
    mainRoot:
      "sd-element sd-question sd-row__question sd-element--complex sd-question--complex sd-question--table",
  ...
  rating: {
    rootDropdown:
      "sd-scrollable-container sd-scrollable-container--compact sd-selectbase",
